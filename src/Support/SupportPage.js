...
import SupportPageCss from "./SupportPageCss.css";
  ...
  return (
    <header>
      <div className="SupportPage-Container">
        <a href="/" className="Logo-Nintendo">
          <svg
            viewBox="0 0 97 24"
        ...
        <div className="SupportPage-TitleSearch">
          <img
            src="img/structure/mario_and_friends.png"
            alt="Mario and friends"
            class="character-leap"
          ></img>
