  ...
  return (
    <div className="Preorder">
      <section className="PreorderTag">
        <div className="PreorderStyle">
          <h1 className="TagStyle">Pre-order digitally today, play on 5/29</h1>
          <a href="" className="PreorderButton">
            <span className="PoButton">Pre-order now</span>
          </a>
          <a
          ...
          >
            <div className="MatureRating">
              ...
              <div className="RatingTxt">
                <div className="TxtStyle">Mild Violence</div>
                <div className="TxtStyle">In-Game Purchase, Users Interact</div>
              </div>
            </div>
          </a>
        </div>
